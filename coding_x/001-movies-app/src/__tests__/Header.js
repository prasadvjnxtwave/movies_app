...
describe('Header tests', () => {
  ...
  // #region - Header Test cases - static

  it('Home Route should consist of an HTML image element in the Header with alt attribute value as "website logo":::5:::', async () => {
    mockGetCookie()
  ...
  it('Home Route should consist of an HTML image element in the Header with alt attribute value as "website logo", wrapped with Link from react-router-dom:::5:::', async () => {
    mockGetCookie()
  ...
  it('Home Route should consist of at least one HTML unordered list element to display the list of nav items in the Header:::5:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />)
  ...
  it('Home Route should consist of HTML list elements to display the nav items in the Header:::5:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />)
  ...
  it('Home Route should consist of an HTML element with text content as "Home" wrapped with Link from react-router-dom:::5:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />)
  ...
  it('Popular Route should consist of an HTML element with text content as "Home" wrapped with Link from react-router-dom:::5:::', async () => {
    mockGetCookie()
  ...
  it('Search Route should consist of an HTML element with text content as "Home" wrapped with Link from react-router-dom:::5:::', async () => {
    mockGetCookie()
  ...
  it('Movie Item Details Route should consist of an HTML element with text content as "Home" wrapped with Link from react-router-dom:::5:::', async () => {
    mockGetCookie()
  ...
  it('Account Route should consist of an HTML element with text content as "Home" wrapped with Link from react-router-dom:::5:::', async () => {
    mockGetCookie()
  ...
  it('Home Route should consist of an HTML element with text content as "Popular" wrapped with Link from react-router-dom:::5:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />)
  ...
  it('Home Route should consist of an HTML button element with data-testid attribute value as "searchButton" in the Header:::5:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />)
    ...
    const searchBtnEl = screen.getByTestId('searchButton')
    expect(searchBtnEl).toBeInTheDocument()
    expect(searchBtnEl.type).toBe('button')
    restoreGetCookieFns()
  })

  it('Home Route should consist of an HTML image element in the Header with alt attribute value as "profile":::5:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />)
  ...
  it('When the website logo in the Header is clicked, then the page should be navigated to Home Route and consist of an HTML main heading element with text content as "Trending Now":::10:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />, {route: popularRoutePath})
    ...
    const imageElt = screen.getByRole('img', {
      name: /website logo/i,
    })
    expect(imageElt).toBeInTheDocument()

    userEvent.click(imageElt)
  ...
  // #region - functionality check in all routes

  it('When the Home link in the Header is clicked in the Popular Route, then the page should be navigated to Home Route and consist of an HTML main heading element with text content as "Trending Now":::10:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />, {route: popularRoutePath})
  ...
  it('When the Home link in the Header is clicked in the Search Route, then the page should be navigated to Home Route and consist of an HTML main heading element with text content as "Trending Now":::10:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />, {route: searchRoutePath})
  ...
  it('When the Home link in the Header is clicked in the Movie Item Details Route, then the page should be navigated to Home Route and consist of an HTML main heading element with text content as "Trending Now":::10:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />, {route: movieItemDetailsRoutePath})
  ...
  it('When the Home link in the Header is clicked in the Account Route, then the page should be navigated to Home Route and consist of an HTML main heading element with text content as "Trending Now":::10:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />, {route: accountRoutePath})
    const homeLink = screen.getAllByRole('link', {
      name: /home/i,
  ...
  // #region - functionality check2

  it('When the Popular link in the Header is clicked in the Home Route, then the page should be navigated to Popular Route and consist of HTML image element with alt and src values as the values of the keys "title" in each option of the corresponding movie item received from the response:::10:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />)
    ...
    const popularLink = screen.getByRole('link', {
      name: /popular/i,
    })
    userEvent.click(popularLink)
